...
const POLY_OPTIONS: SelectOption<Mapping>[] = [
  ...
  { value: 'delivery', label: `${TYPE_META.delivery.name} (polygon)` },
            ...
            <div key={g.key} className={styles.row}>
              ...
              <div className={styles.rowSelect}>
                <Select<Mapping>
                  ...
                  options={(g.geometry === 'poly' ? POLY_OPTIONS : POINT_OPTIONS).filter((o) => o.value === 'ignore' || moduleEnabled(state, o.value as UnitType))}
