...
const SPACE_RESOURCE_LABEL: Record<UnitType, string> = {
  workstation: 'Desk',
  parking: 'Parking',
  room: 'Location',
...
const SPACE_FORM_NAME: Record<UnitType, string> = {
  ...
  delivery: 'Delivery Booking Form',
  locker: 'Locker Form',
...
function BookingFormInner() {
  ...
  // Zone bookings (rooms, delivery areas) carry attendees; a desk or stall does not.
